...
\begin{center}
    \begin{tikzpicture}[node distance=1cm]
        ...
        %% parameters
        \node (parS1-I1) 
              [right of=S1, xshift = 1cm, yshift=0.25cm] {$(\beta I_1 + \pi \beta I_2)/N_1$};
        \node (parI1-R1) 
              [right of=I1, xshift = 1cm, yshift=0.25cm] {$\gamma$};
        \node (parS2-I2) 
              [right of=S2, xshift = 1cm, yshift=0.25cm] {$(\pi \beta I_1 + \beta I_2)/N_2$};
        \node (parI2-R2) 
...
\begin{align}
    \frac{dS_1}{dt} &= (1-v_e)v\mu(N_1 + N_2) - (\beta I_1 + \pi \beta I_2)S_1/N_1 - \mu S_1  \\
    \frac{dI_1}{dt} &= (\beta I_1 + \pi \beta I_2)S_1/N_1 - (\gamma + \mu) I_1 \\
    \frac{dR_1}{dt} &= v_e v \mu(N_1 + N_2) + \gamma I_1 - \mu R_1 \\
    \frac{dS_2}{dt} &= (1-v)\mu(N_1 + N_2) - (\pi \beta I_1 + \beta I_2)S_2/N_2 - \mu S_2 \\
    \frac{dI_2}{dt} &= (\pi \beta I_1 + \beta I_2)S_2/N_2 - (\gamma + \mu) I_2 \\
    \frac{dR_2}{dt} &= v\mu (N_1 + N_2) + \gamma I_2 - \mu R_2
\end{align}

\noindent
We can represent the jacobian, $J$ as follows:

\[
J = 
\begin{pmatrix}
-\frac{\beta I_1 + \pi \beta I_2}{N_1} - \mu & -\frac{\beta S_1}{N_1} & 0 & 0 & -\frac{\pi \beta S_1}{N_1} & 0 \\
\frac{\beta I_1 + \pi \beta I_2}{N_1} & \frac{\beta S_1}{N_1} - (\gamma + \mu) & 0 & 0 & \frac{\pi \beta S_1}{N_1} & 0 \\
0 & \gamma & -\mu & 0 & 0 & 0 \\
0 & -\frac{\pi \beta S_2}{N_2} & 0 & -\frac{\pi \beta I_1 + \beta I_2}{N_2} - \mu & -\frac{\beta S_2}{N_2} & 0 \\
0 & \frac{\pi \beta S_2}{N_2} & 0 & \frac{\pi \beta I_1 + \beta I_2}{N_2} & \frac{\beta S_2}{N_2} - (\gamma + \mu)& 0 & \\
0 & 0 & 0 & 0 & \gamma & -\mu \\
\end{pmatrix}
\]
