...
\noindent
But we know that $\lambda_A$ and $\lambda_B$ are the $R_0$ values for patch 1 and patch 2, respectively. Thus, $\alpha = \frac{\phi R_{0,B} - R_{0,A}}{\phi R_{0,A} + R_{0,B}}$.

We should be able to write patch specific R0 in terms of $v_1$ and $v_2$....
