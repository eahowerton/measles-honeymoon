...
# save results
saveRDS(susc_after_release_long_full, "R/FINAL/data/susc_after_release_long.rds")
saveRDS(rt_after_release_full_long, "R/FINAL/data/rt_after_release_long.rds")
